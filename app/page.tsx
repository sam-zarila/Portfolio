...
export default function Home() {
  ...
  <div className="container mx-auto mt-10 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div className="bg-[#15172b] py-10 px-5 rounded-lg shadow-lg transition-transform transform hover:scale-105 duration-300">
      <h3 className="text-2xl font-bold text-yellow-400">SEO</h3>
      <p className="text-gray-400 mt-2">SEO - 60%</p>
      <div className="mt-4">
        <div className="relative pt-1">
          <div className="flex items-center justify-between">
            <div className="text-xs font-semibold text-yellow-400">60%</div>
          </div>
          <div className="flex h-2 rounded bg-gray-700">
            <div className="bg-yellow-400 h-full rounded" style={{ width: '60%' }}></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <h2 className="text-4xl font-extrabold text-white">My Services</h2>
  <div className="container mx-auto mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div className="bg-[#0d0e15] py-10 px-5 rounded-lg shadow-lg transition-transform transform hover:scale-105 duration-300">
      ...
      <h3 className="text-2xl font-bold text-yellow-400">E-commerce Web Design</h3>
      <p className="text-gray-400 mt-2">Creating user-friendly online stores that boost your sales.</p>
    </div>
  </div>
</section>
<section className="py-20 bg-[#0d0e15] text-center">
  <h2 className="text-4xl font-extrabold text-white">My Work Experience</h2>
